...
namespace BetterGuestBook
{
    internal class Program
    {
        ...
        {
            List <GuestModel> guests = new List <GuestModel> ();//I create a List instead of array because I don't know how many "guests" will attend (array is when i know the number of "guests")
